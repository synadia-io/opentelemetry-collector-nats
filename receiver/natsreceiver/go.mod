module github.com/synadia-io/opentelemetry-collector-nats/receiver/natsreceiver
...
require (
	...
	github.com/synadia-io/opentelemetry-collector-nats/internal/natsclient v0.1.0
