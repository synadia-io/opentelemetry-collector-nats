module github.com/synadia-io/opentelemetry-collector-nats/exporter/natsexporter
...
require (
	...
	github.com/synadia-io/opentelemetry-collector-nats/internal/natsclient v0.2.0
